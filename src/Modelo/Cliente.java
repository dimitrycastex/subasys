...
public class Cliente {
   ...
   public static void nuevo(ArrayList unaLista)
 {
  ...
  public static boolean setUpdate(String RUT,ArrayList unaLista) {
        ...
        stat.executeUpdate("update Cliente set Web='"+unaLista.get(5).toString()+"' where RUT = "+"'"+RUT+"'");
        stat.executeUpdate("update Cliente set TelefonoMovil='"+unaLista.get(6).toString()+"' where RUT = "+"'"+RUT+"'"); 
        stat.executeUpdate("update Cliente set CodigoPostal="+Integer.parseInt(unaLista.get(7).toString())+" where RUT = "+"'"+RUT+"'");
        stat.executeUpdate("update Cliente set Direccion='"+unaLista.get(8).toString()+"' where RUT = "+"'"+RUT+"'");
        stat.executeUpdate("update Cliente set Ciudad='"+unaLista.get(9).toString()+"' where RUT = "+"'"+RUT+"'");
        stat.executeUpdate("update Cliente set Comuna='"+unaLista.get(10).toString()+"' where RUT = "+"'"+RUT+"'");
        return true;
