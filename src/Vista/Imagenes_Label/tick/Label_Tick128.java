 ...
 * @author bastian
 */
public class Label_Tick128 extends JLabel{
    
    public Label_Tick128(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/tick/128.png"));
        return Imagen;
    }
