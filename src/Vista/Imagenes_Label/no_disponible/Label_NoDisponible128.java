 ...
 * @author bastian
 */
public class Label_NoDisponible128 extends JLabel{
    
    public Label_NoDisponible128(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/no_disponible/128.png"));
        return Imagen;
    }
