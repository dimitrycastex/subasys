 ...
 * @author bastian
 */
public class Label_NoDisponible32 extends JLabel{
    
    public Label_NoDisponible32(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/no_disponible/32.png"));
        return Imagen;
    }
