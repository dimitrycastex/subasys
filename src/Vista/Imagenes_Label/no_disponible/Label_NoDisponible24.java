 ...
 * @author bastian
 */
public class Label_NoDisponible24 extends JLabel{
    
    public Label_NoDisponible24(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/no_disponible/24.png"));
        return Imagen;
    }
