 ...
 * @author bastian
 */
public class Label_NoDisponible48 extends JLabel{
    
    public Label_NoDisponible48(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/no_disponible/48.png"));
        return Imagen;
    }
