 ...
 * @author bastian
 */
public class Label_Justicia128 extends JLabel{
    
    public Label_Justicia128(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/justicia/128.png"));
        return Imagen;
    }
