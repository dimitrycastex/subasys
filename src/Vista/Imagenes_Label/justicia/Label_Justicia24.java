 ...
 * @author bastian
 */
public class Label_Justicia24 extends JLabel{
    
    public Label_Justicia24(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/justicia/24.png"));
        return Imagen;
    }
