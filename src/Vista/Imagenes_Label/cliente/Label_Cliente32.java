 ...
 * @author bastian
 */
public class Label_Cliente32 extends JLabel{
    
    public Label_Cliente32(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/cliente/32.png"));
        return Imagen;
    }
