 ...
 * @author bastian
 */
public class Label_FechaAdelante48 extends JLabel{
    
    public Label_FechaAdelante48(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/flechas/adelante/48.png"));
        return Imagen;
    }
