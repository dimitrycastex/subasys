 ...
 * @author bastian
 */
public class Label_Cruz128 extends JLabel{
    
    public Label_Cruz128(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/cruz/128.png"));
        return Imagen;
    }
