 ...
 * @author bastian
 */
public class Label_Factura24 extends JLabel{
    
    public Label_Factura24(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/factura/24.png"));
        return Imagen;
    }
