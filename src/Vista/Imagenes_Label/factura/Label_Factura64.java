 ...
 * @author bastian
 */
public class Label_Factura64 extends JLabel{
    
    public Label_Factura64(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/factura/64.png"));
        return Imagen;
    }
