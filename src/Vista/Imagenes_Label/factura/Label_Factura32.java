 ...
 * @author bastian
 */
public class Label_Factura32 extends JLabel{
    
    public Label_Factura32(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/factura/32.png"));
        return Imagen;
    }
