 ...
 * @author bastian
 */
public class Label_Producto32 extends JLabel{
    
    public Label_Producto32(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/producto/32.png"));
        return Imagen;
    }
