 ...
 * @author bastian
 */
public class Label_Producto64 extends JLabel{
    
    public Label_Producto64(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/producto/64.png"));
        return Imagen;
    }
