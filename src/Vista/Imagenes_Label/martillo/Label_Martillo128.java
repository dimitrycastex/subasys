 ...
 * @author bastian
 */
public class Label_Martillo128 extends JLabel{
    
    public Label_Martillo128(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/martillo/128.png"));
        return Imagen;
    }
