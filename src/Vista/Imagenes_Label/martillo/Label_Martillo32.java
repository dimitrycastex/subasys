 ...
 * @author bastian
 */
public class Label_Martillo32 extends JLabel{
    
    public Label_Martillo32(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/martillo/32.png"));
        return Imagen;
    }
