 ...
 * @author bastian
 */
public class Label_Martillo16 extends JLabel{
    
    public Label_Martillo16(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/martillo/16.png"));
        return Imagen;
    }
