 ...
 * @author bastian
 */
public class Label_Martillo48 extends JLabel{
    
    public Label_Martillo48(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/martillo/48.png"));
        return Imagen;
    }
