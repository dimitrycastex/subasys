 ...
 * @author bastian
 */
public class Label_Database128 extends JLabel{
    
    public Label_Database128(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/database/128.png"));
        return Imagen;
    }
