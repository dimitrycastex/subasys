 ...
 * @author bastian
 */
public class Label_Database24 extends JLabel{
    
    public Label_Database24(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/database/24.png"));
        return Imagen;
    }
