 ...
 * @author bastian
 */
public class Label_Database48 extends JLabel{
    
    public Label_Database48(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/database/48.png"));
        return Imagen;
    }
