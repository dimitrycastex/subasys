 ...
 * @author bastian
 */
public class Label_Salir32 extends JLabel{
    
    public Label_Salir32(){
        super();
        this.setText(null);
    ...
    public ImageIcon RetornaImagen(){
        ImageIcon Imagen = new ImageIcon(this.getClass().getResource("/Vista/Imagenes_Files/salir/32.png"));
        return Imagen;
    }
